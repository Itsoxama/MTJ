    ...
    */}
            ...
            <div className="sitemap">
                ...
                <div className="hhx hhx2">
                    ...
                    <button className='addemp' onClick={e => setadduser('adduser fixedarea')} >+ Add User</button>
                    ...
                    <div className="tablerow">
                        <div className="subtable">
                            <div className="headertable clop">
                                ...
                                <h6>phone</h6>
                                <h3 style={{ width: "70px" }}>Gender</h3>
                                <h4 style={{ width: "100px" }}>Date of birth</h4>
                            ...
                            {searchval.length > 0 && filter === 'name' && data && data.map(val => (
                                ...
                                <>
                                    <div className="headertable">
                                        ...
                                        <h6>{val.phone}</h6>
                                        <h3 style={{ width: "70px" }} >{val.gender}</h3>
                                        <h4 style={{ width: "100px" }} >{val.dob}</h4>
